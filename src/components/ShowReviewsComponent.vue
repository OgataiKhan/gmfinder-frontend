...
<template>
	<div class="container py-5">
		<h3 class="mb-4">
			Reviews ({{
				store.selectedGameMaster.reviews
					? store.selectedGameMaster.reviews.length
					: "No Reviews"
			}})
		</h3>
		...
		<!-- navigation buttons -->
		<div class="d-flex">
			<button class="me-auto" @click="prevPage" v-if="currentPage > 1">
				Previous
			</button>
			<button
				class="ms-auto"
...
<style scoped lang="scss">
	...
	@import "/src/scss/components/show_reviews.scss";
</style>
