<script>
	...
	export default {
		...
		mounted() {
			...
			axios
				.get(
					this.store.api.baseURL + this.store.api.apiUrls.game_systems
				)
				.then((response) => {
	...
	<div
		...
		<form
			...
			<div
				...
				class="validation-alert align-self-start">
			...
			<div
				...
				<div class="d-flex flex-column align-items-center">
					<label for="avgRating" class="form-label mt-2"
			...
			<!-- submit button -->
			<div class="mt-1">
				<button type="submit" class="mx-auto mt-4 mt-md-2">
					Search
				</button>
			</div>
			<!-- /submit button -->
...
<style scoped lang="scss">
	...
	@import "/src/scss/components/search_component.scss";
</style>
